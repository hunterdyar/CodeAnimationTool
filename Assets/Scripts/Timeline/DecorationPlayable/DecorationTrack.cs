...
namespace CodeAnimator
{
    ...
    [TrackClipType(typeof(DecorationPlayableAsset))]
    [TrackBindingType(typeof(TextRenderer))]
    public class DecorationTrack : TrackAsset
    {
        ...
        {
            var mixer = ScriptPlayable<DecorationTrackMixerBehaviour>.Create(graph, inputCount);
